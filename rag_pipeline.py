...
def create_product_retriever():
    ...
    # Product documentation is chunked because
    # individual pages/sections can contain a lot of information.
    text_splitter = RecursiveCharacterTextSplitter(
        chunk_size=1000,
        chunk_overlap=200
    )
    product_chunks = text_splitter.split_documents(
        documents
    )
...
def create_issue_retriever():
    ...
    # IMPORTANT:
    # Do not split/chunk these documents.    
    ...
    # issue
    # resolution
    # remain together as one complete support record.
